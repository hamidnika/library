        ...
        <div className="col-md-4">
          <div className="card">
            <div className="card-body bg-secondary text-white">
              <h4 className="card-title text-warning bg-dark">Our Mission for Booklook Network</h4>
              <div> <p className="card-text">In 2002, Hamid Nikou pursued the profession of translator after graduation and focused on the field of specialized literature in political science and the press. The result of these years was the translation of many articles and books in the field of political science and international relations. Strengthening capabilities in the field of translation and editing of texts gradually led to specialized compilation in the field of regional studies. This experience led him to continue his studies in European studies. I’m an Iranian political researcher / analyst and translator, pursuing PhD in political science, with focus on assessment of identity, culture and minorities in Middle East and Europe. I hold Master degree in Regional studies and European studies and a Bachelor degree in English literature / language.</p></div> 
